...
Roadmap boards additionally support **archival** — older completed roadmaps can be archived without deletion, keeping your active roadmap focused.
...
## Archiving Roadmap Boards

Roadmap boards support archival — useful when a roadmap phase wraps up but you want to keep the history:

- Open the roadmap board → **Settings → Archive Board**
- Archived boards are hidden from the public portal but remain accessible in the admin
- Unarchive at any time

Feedback boards don't support archival in the same way — instead, set their visibility to **Internal** or delete them when no longer needed.
