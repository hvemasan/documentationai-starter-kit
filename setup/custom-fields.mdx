...
<Card title="Open Feedback Boards" href="https://app.productbridge.io/dashboard/settings/feedback" icon="list-plus" horizontal="true">
  Sidebar → **Settings** → Modules → **Feedback** → open a board
</Card>
...
**In-app path:** Sidebar → **Settings** → Modules → **Feedback** → open a board → **Custom fields**

**Requires:** `feedback_board:manage`.

<Callout kind="info">
  Custom fields are **per board**, not organization-wide. They live inside the board editor panel, so there is no standalone Custom Fields page — open the board you want the field on and configure it there.
</Callout>
...
<Steps>
  <Step title="Open the board" icon="clipboard-list">
    Go to [**Settings → Feedback**](https://app.productbridge.io/dashboard/settings/feedback) and open the feedback board you want the field on.
  </Step>
