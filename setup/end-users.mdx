...
<Card title="Open Users" href="https://app.productbridge.io/dashboard/users" icon="users" horizontal="true">
  Sidebar → **Users**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/users](https://app.productbridge.io/dashboard/users)

**In-app path:** Sidebar → **Users**

**Requires:** `member:view`.

Useful deep links on this page:

| Goal | Direct link |
|------|-------------|
| All end users | [`/dashboard/users`](https://app.productbridge.io/dashboard/users) |
| Search for a user | [`/dashboard/users?q=jane@acme.com`](https://app.productbridge.io/dashboard/users) — append `?q=` plus the name or email |
| Open one user's profile | `/dashboard/users?user={userId}` |
| Filter by segment | `/dashboard/users?segment={segmentId}` |
| Your internal team instead | [`/dashboard/settings/team`](https://app.productbridge.io/dashboard/settings/team) |
