...
<Card title="Open Changelog" href="https://app.productbridge.io/dashboard/changelog" icon="megaphone" horizontal="true">
  Reactions are left by your users on the public portal — there is no settings page for them
</Card>

**Direct link (your changelog):** [https://app.productbridge.io/dashboard/changelog](https://app.productbridge.io/dashboard/changelog)

**Where users react:** on your public portal — `https://{your-subdomain}.productbridge.io/changelog` and on help articles

**Requires:** nothing to enable. The reaction set is fixed and always on.

<Callout kind="info">
  Reactions have no configuration screen: you can't add, remove, or rename the emoji set. If you want a signal you can configure and prioritize on, use [votes](/setup/boards) instead.
</Callout>
...
This set is the same across all reactable surfaces today. Custom emoji aren't supported, and per-surface visibility toggles aren't configurable in the UI today.
