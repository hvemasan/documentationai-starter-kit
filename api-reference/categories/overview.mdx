...
The API lets you list, retrieve, create, and delete categories. To change the category assigned to a specific post, use the [update feedback post endpoint](/api-reference/feedback-posts/update).
