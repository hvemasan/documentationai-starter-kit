...
Unlike deleting a single comment, this bulk operation emits **no** `comment.deleted` webhook events — webhook receivers are not notified of the removed comments.
