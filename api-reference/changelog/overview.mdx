...
A changelog entry is a published release note — typically announcing a new feature, bug fix, or improvement. Entries are visible on your organization's public changelog feed and can be syndicated to email subscribers.
