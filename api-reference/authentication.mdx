...
<Steps>
  <Step title="Open the dashboard" icon="settings" title-type="p">
    Sign in and go to [**Settings → Connect → API & Webhooks**](https://app.productbridge.io/dashboard/settings/api-webhooks), then find the **API key** section.
  </Step>

  <Step title="Generate the key" icon="key-round" title-type="p">
  ...
  <Step title="Copy the raw key" icon="copy" title-type="p">
...
<Steps>
  <Step title="Open Settings → Connect → API & Webhooks" icon="settings" title-type="p">
    The **API key** section shows your current key prefix (`pb_xxxxx`) and a "Rotate" button.
  </Step>

  <Step title="Click Rotate" icon="refresh-cw" title-type="p">
    A confirmation dialog warns that the existing key will be invalidated immediately. Confirm.
  </Step>

  <Step title="Copy the new key" icon="copy" title-type="p">
