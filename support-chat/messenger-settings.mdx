...
<Card title="Open Messenger settings" href="https://app.productbridge.io/dashboard/settings/messenger" icon="sliders-horizontal" horizontal="true">
...
Open [**Settings → Messenger**](https://app.productbridge.io/dashboard/settings/messenger). The page has three tabs — **Customization**, **Conversations**, and **Installation** — with a **live preview** beside them: the real messenger, repainted on every keystroke, with a Light/Dark toggle so you can check both themes before saving. Nothing ships until you press **Save Changes**.
