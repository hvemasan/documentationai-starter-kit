...
<Card title="Open Survey settings" href="https://app.productbridge.io/dashboard/settings/survey" icon="code" horizontal="true">
  Sidebar → **Settings** → Modules → **Survey**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/survey](https://app.productbridge.io/dashboard/settings/survey)
...
<Callout kind="info">
  The install snippet lives in **Settings → Survey**, not on the Surveys page. Build surveys at [`/dashboard/surveys`](https://app.productbridge.io/dashboard/surveys); install the script that shows them at [`/dashboard/settings/survey`](https://app.productbridge.io/dashboard/settings/survey).
</Callout>
