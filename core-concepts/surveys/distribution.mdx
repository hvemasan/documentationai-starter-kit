...
This is the channel to use for auto-triggered surveys (like a recurring NPS) and event-triggered surveys (like a CSAT after a completed task). See [Installation & SDK](/core-concepts/surveys/installation) to add the script and [Targeting & Triggers](/core-concepts/surveys/targeting-and-triggers) to control when surveys appear.
