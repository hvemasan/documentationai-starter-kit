...
<Card title="Open Surveys" href="https://app.productbridge.io/dashboard/surveys" icon="send" horizontal="true">
  Sidebar → **Surveys** → open a survey → **Share by link**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/surveys](https://app.productbridge.io/dashboard/surveys)

**In-app path:** Sidebar → **Surveys** → open a survey → **Share by link** in the editor
