...
<Card title="Open Surveys" href="https://app.productbridge.io/dashboard/surveys" icon="pencil" horizontal="true">
...
| Trigger | **Auto** (on page load), **Event** (when your app fires a named event), or **Manual** (only when your app calls `startSurvey()`). See [Targeting & Triggers](/core-concepts/surveys/targeting-and-triggers#triggers). |
