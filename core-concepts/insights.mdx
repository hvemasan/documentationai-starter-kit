...
<Card title="Open Insights" href="https://app.productbridge.io/dashboard/themes" icon="lightbulb" horizontal="true">
  Sidebar → **Insights**
</Card>
...
In the dashboard sidebar, the Overview lives under **Intelligence → Analytics**, while Themes, Observations, and Strengths are in-page tabs under **Intelligence → Insights**.
