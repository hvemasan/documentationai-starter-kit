...
<Card title="Open Changelog" href="https://app.productbridge.io/dashboard/changelog" icon="megaphone" horizontal="true">
  Sidebar → **Changelog**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/changelog](https://app.productbridge.io/dashboard/changelog)

**In-app path:** Sidebar → **Changelog**

**Requires:** `changelog:view` to read, `changelog:manage` to write and publish.

| Goal | Direct link |
|------|-------------|
| Write and publish entries | [`/dashboard/changelog`](https://app.productbridge.io/dashboard/changelog) |
| Manage changelog labels | [`/dashboard/settings/changelog`](https://app.productbridge.io/dashboard/settings/changelog) |
| Turn the Changelog tab on for your portal | [`/dashboard/settings/public-portal`](https://app.productbridge.io/dashboard/settings/public-portal) |
| Your public changelog | `https://{your-subdomain}.productbridge.io/changelog` |
