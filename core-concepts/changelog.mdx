...
Your changelog is accessible at a public URL like `https://changelog.productbridge.io/your-project`. The page displays entries in reverse chronological order, with filtering by tag and a search bar.
