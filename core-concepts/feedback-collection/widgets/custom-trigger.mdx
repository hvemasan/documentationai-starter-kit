...
<Card title="Open Custom Trigger setup" href="https://app.productbridge.io/dashboard/settings/widget-embeds?embed=trigger" icon="mouse-pointer-click" horizontal="true">
  Sidebar → **Settings** → Connect → **Widget & Embeds** → **Custom Trigger**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/widget-embeds?embed=trigger](https://app.productbridge.io/dashboard/settings/widget-embeds?embed=trigger)

**In-app path:** Sidebar → **Settings** → Connect → **Widget & Embeds** → **Custom Trigger** in the left rail
...
| Tab | Direct link |
|------|-------------|
| **Embed Code** | [`?tab=embed`](https://app.productbridge.io/dashboard/settings/widget-embeds?tab=embed&embed=trigger) |
