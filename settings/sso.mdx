...
description: >-
  ...
  Configure a JWT redirect flow so ProductBridge hands off authentication to
  your app — no password required on the ProductBridge side.
---

## Where to find it

<Card title="Open SSO settings" href="https://app.productbridge.io/dashboard/settings/sso" icon="lock" horizontal="true">
  Sidebar → **Settings** → Connect → **SSO**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/sso](https://app.productbridge.io/dashboard/settings/sso)
...
|------|-------------|---------------|
| **SSO Redirect** | [`/dashboard/settings/sso`](https://app.productbridge.io/dashboard/settings/sso) | The three-step redirect setup — configure the login URL, test the round trip, turn it on |
| **API Keys** | [`/dashboard/settings/sso?tab=api-keys`](https://app.productbridge.io/dashboard/settings/sso?tab=api-keys) | The private key used to sign SSO and widget identity JWTs |
...
<Image src="https://blob-cdn.documentation.ai/org-6d15960a-f17b-4433-b5fa-97a7529e5a1e/doc-b4e5d932-0b09-4a99-99af-e9279cdd4ad6/1778333127314-5hqr02zbnrs-sso_redirect_tab_initial_setup_framed.png?fm=auto&auto=compress%2Cformat" width="1940" height="1100" alt="" />
...
Go to the [**SSO Redirect** tab](https://app.productbridge.io/dashboard/settings/sso) to configure the three steps below. Each step is a card that shows its own status chip — **Set**, **Passed**, **Live** — so you can see how far the setup has got at a glance.

<Image src="https://blob-cdn.documentation.ai/org-6d15960a-f17b-4433-b5fa-97a7529e5a1e/doc-b4e5d932-0b09-4a99-99af-e9279cdd4ad6/1778333244052-xe6bebhaft-pasted-image-1778333234935.png?fm=auto&auto=compress%2Cformat" width="1940" height="1100" alt="" />
...
<Image src="https://blob-cdn.documentation.ai/org-6d15960a-f17b-4433-b5fa-97a7529e5a1e/doc-b4e5d932-0b09-4a99-99af-e9279cdd4ad6/1778333302603-deicnm3ub4n-pasted-image-1778333293816.png?fm=auto&auto=compress%2Cformat" width="1938" height="1038" alt="" />
...
Go to the [**API Keys** tab](https://app.productbridge.io/dashboard/settings/sso?tab=api-keys). If no key exists yet, click **Generate key** — the button reads **Regenerate** once a key is active.

<Image src="https://blob-cdn.documentation.ai/org-6d15960a-f17b-4433-b5fa-97a7529e5a1e/doc-b4e5d932-0b09-4a99-99af-e9279cdd4ad6/1778333390435-8spl3kjektt-pasted-image-1778333380692.png?fm=auto&auto=compress%2Cformat" width="1940" height="1100" alt="" />

After generation, the full secret is shown **once**. Copy it immediately and store it in your server environment.

<Image src="https://blob-cdn.documentation.ai/org-6d15960a-f17b-4433-b5fa-97a7529e5a1e/doc-b4e5d932-0b09-4a99-99af-e9279cdd4ad6/1778333421976-dcxdkh02dfe-pasted-image-1778333413175.png?fm=auto&auto=compress%2Cformat" width="1940" height="1100" alt="" />
...
<Callout kind="alert">
  **The Widget Auth tab has been removed from the dashboard.** The SSO settings page now has only two tabs — **SSO Redirect** and **API Keys**. To set up widget identity verification, go to [**Settings → Connect → Widget & Embeds**](https://app.productbridge.io/dashboard/settings/widget-embeds), where the **User Identity Verification** section shows the JWT snippet to use.
...
<Image src="https://blob-cdn.documentation.ai/org-6d15960a-f17b-4433-b5fa-97a7529e5a1e/doc-b4e5d932-0b09-4a99-99af-e9279cdd4ad6/1778333495547-g6d0gidb7qt-pasted-image-1778333485351.png?fm=auto&auto=compress%2Cformat" width="1940" height="1100" alt="" />
...
<Image src="https://blob-cdn.documentation.ai/org-6d15960a-f17b-4433-b5fa-97a7529e5a1e/doc-b4e5d932-0b09-4a99-99af-e9279cdd4ad6/1778333544514-byi6q6m7usa-pasted-image-1778333535456.png?fm=auto&auto=compress%2Cformat" width="1940" height="1100" alt="" />
...
<ExpandableGroup>
  <Expandable title="Test says 'Token verification failed'" default-open="false">
    The JWT signature did not match. Check that the secret used to sign the token matches the API key displayed in [**Settings → SSO → API Keys**](https://app.productbridge.io/dashboard/settings/sso?tab=api-keys). The key is only shown once — if you are unsure, generate a new one and update your server environment variable.
  </Expandable>
  ...
  <Expandable title="Widget shows 'Please log in' even after passing a userToken" default-open="false">
    The most common cause is a signature mismatch. Verify that `PRODUCTBRIDGE_WIDGET_SECRET` on your server matches the key in [**Settings → SSO → API Keys**](https://app.productbridge.io/dashboard/settings/sso?tab=api-keys). Also confirm you are using the `HS256` algorithm — other algorithms are not accepted.
  </Expandable>
</ExpandableGroup>
