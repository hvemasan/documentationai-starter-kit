...
<Card title="Open SEO settings" href="https://app.productbridge.io/dashboard/settings/brand?tab=seo" icon="search" horizontal="true">
  Sidebar → **Settings** → Organization → **Brand Settings** → **SEO** tab
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/brand?tab=seo](https://app.productbridge.io/dashboard/settings/brand?tab=seo)

**In-app path:** Sidebar → **Settings** → Organization → **Brand Settings** → **SEO** tab

**Requires:** `organization:manage`.

Visibility is set per board, not on this page:

| What you want to change | Direct link |
|--------------------------|-------------|
| Portal SEO — title, description, indexing | [`/dashboard/settings/brand?tab=seo`](https://app.productbridge.io/dashboard/settings/brand?tab=seo) |
| Who can see a feedback board | [`/dashboard/settings/feedback`](https://app.productbridge.io/dashboard/settings/feedback) |
| Who can see a roadmap board | [`/dashboard/settings/roadmap`](https://app.productbridge.io/dashboard/settings/roadmap) |
| User segments used by segmented boards | [`/dashboard/users`](https://app.productbridge.io/dashboard/users) |
...
<Steps>
  <Step title="Open SEO settings" icon="search">
    Go to [**Settings → Brand Settings → SEO**](https://app.productbridge.io/dashboard/settings/brand?tab=seo).
  </Step>
...
Set a board's visibility when creating or editing it: go to [**Settings → Feedback**](https://app.productbridge.io/dashboard/settings/feedback) (or [**Settings → Roadmap**](https://app.productbridge.io/dashboard/settings/roadmap)), open the board, and choose an option under **Who can see posts**. Feedback boards also have a separate **Who can create posts** control — see [Boards](/setup/boards) for the full breakdown.
