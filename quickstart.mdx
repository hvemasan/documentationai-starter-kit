...
<Steps>
  ...
  <Step title="Verify Email and Log In" icon="mail">
    ...
    Return to `https://app.productbridge.io/login`, enter your credentials, and click **Sign In**.
...
<Tabs>
  <Tab title="Public Portal" icon="globe">
    Share your portal link (`https://feedback.productbridge.io/your-project`) with users or teammates.
  ...
  <Tab title="In-App Widget" icon="code">
    ...
    ```html
    <script
      src="https://widget.productbridge.io/v1/widget.js"
...
<Columns cols={3}>
  ...
  <Card title="Integrations" icon="plug" href="/integrations/communication-channels">
