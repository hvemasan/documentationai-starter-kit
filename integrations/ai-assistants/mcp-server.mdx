...
<Steps>
  <Step title="Generate your connection config" icon="key">
    In the ProductBridge admin, go to [**Settings → Connect → MCP Server**](https://app.productbridge.io/dashboard/settings/mcp-server) and click **Generate MCP Config**.
...
1. Go to [**Settings → Connect → MCP Server**](https://app.productbridge.io/dashboard/settings/mcp-server)
2. Click **Regenerate**
