...
<Card title="Open Freshdesk in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations/freshdesk" icon="headphones" horizontal="true">
  Sidebar → **Connect Sources** → **Freshdesk**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/integrations/freshdesk](https://app.productbridge.io/dashboard/settings/integrations/freshdesk)

**In-app path:** Sidebar → **Connect Sources** → **Freshdesk**
