...
<img src="https://raw.githubusercontent.com/hvemasan/documentationai-starter-kit/main/images/logos/discord.svg" width="80" height="80" alt="" />


## Where to find it

<Card title="Open Discord in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations/discord" icon="message-square" horizontal="true">
  Sidebar → **Connect Sources** → **Discord**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/integrations/discord](https://app.productbridge.io/dashboard/settings/integrations/discord)

**In-app path:** Sidebar → **Connect Sources** → **Discord**
...
<Steps>
  ...
  <Step title="Click Add to Discord" icon="plus" title-type="p">
...
<Expandable title="Troubleshooting" default-open="false">
  ...
  - **Re-authorize** — If the connection stops working, revoke and reconnect from **Connect Sources > Discord**. This refreshes the bot token, re-registers the slash command, and re-establishes the interaction endpoint.
</Expandable>
