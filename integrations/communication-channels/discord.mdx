...
description: Connect ProductBridge to Discord to capture feedback via the /productbridge slash command, and send notifications about new feedback, status changes, and vote milestones to designated channels.
---
...
<Steps>
  <Step title="Open the Admin Dashboard" icon="layout-dashboard" title-type="p">
    ...
    <Image src="placeholder-discord-integrations-page.png" width="900" height="500" alt="ProductBridge admin dashboard showing the Discord integration card" />
  </Step>
  ...
  <Step title="Click Connect Discord" icon="plus" title-type="p">
    ...
    <Image src="placeholder-discord-connect-button.png" width="900" height="500" alt="Discord integration page with the Connect Discord button highlighted" />
  </Step>
  ...
  <Step title="Confirm Installation" icon="check-circle" title-type="p">
    After authorization, Discord redirects you back to ProductBridge. The integration status updates to **Connected**, and the page now displays your server name, server ID, and the registered application ID.
    ...
    <Image src="placeholder-discord-connected-status.png" width="900" height="500" alt="ProductBridge integration settings showing Discord as connected with server info" />
  </Step>
</Steps>
...
<Steps>
  <Step title="Run the Slash Command" icon="terminal" title-type="p">
    ...
    <Image src="placeholder-discord-slash-command-autocomplete.png" width="900" height="500" alt="Discord channel showing the /productbridge slash command in the autocomplete dropdown" />
  </Step>
...
<Image src="placeholder-discord-notification-embed.png" width="900" height="500" alt="Discord channel showing a rich embed notification card for new feedback" />
