...
<img src="https://raw.githubusercontent.com/hvemasan/documentationai-starter-kit/main/images/logos/gong.png" width="80" height="80" alt="Gong" />


## Where to find it

<Card title="Open Gong in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations/gong" icon="phone-call" horizontal="true">
  Sidebar → **Connect Sources** → **Gong**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/integrations/gong](https://app.productbridge.io/dashboard/settings/integrations/gong)

**In-app path:** Sidebar → **Connect Sources** → **Gong**
