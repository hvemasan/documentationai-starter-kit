...
2. **Automatic Ticket Analysis** — When a ticket is created with any status, ProductBridge receives a webhook event, fetches the full conversation, and runs it through an AI pipeline. Tickets that contain product feedback automatically become posts.
