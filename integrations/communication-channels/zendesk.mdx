...
<img src="https://raw.githubusercontent.com/hvemasan/documentationai-starter-kit/main/images/logos/zendesk.svg" width="80" height="80" alt="Zendesk" />

## Where to find it

<Card title="Open Zendesk in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations/zendesk" icon="life-buoy" horizontal="true">
  Sidebar → **Connect Sources** → **Zendesk**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/integrations/zendesk](https://app.productbridge.io/dashboard/settings/integrations/zendesk)

**In-app path:** Sidebar → **Connect Sources** → **Zendesk**
...
<Steps>
  ...
  <Step title="Enter Your Subdomain and Connect" icon="key" title-type="p">
...
<Expandable title="Troubleshooting" default-open="false">
  ...
  - **Tickets not creating feedback** — Not every ticket contains product feedback. The AI pipeline only creates posts when it detects actionable product input with sufficient confidence. Also remember that only solved and closed tickets are analyzed. Check the activity on **Connect Sources > Zendesk** to see which tickets were processed and why each was accepted or discarded.
  ...
  - **Historical import taking a long time** — Import volume depends on how many tickets were solved or closed in your chosen window. It runs as a background job and new tickets are processed in real time independently.

  - **Re-authorize** — If the connection stops working, revoke and reconnect from **Connect Sources > Zendesk**. This refreshes credentials, re-registers the webhook and trigger, and reinstalls the sidebar app.
</Expandable>
