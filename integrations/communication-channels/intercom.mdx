...
description: Connect ProductBridge to Intercom to automatically capture feedback from support conversations and let your team submit feedback directly from the Intercom sidebar.
---

<img src="https://cdn.simpleicons.org/intercom/000000" width="80" height="80" alt="Intercom" />
...
<Steps>
  <Step title="Open the Admin Dashboard" icon="layout-dashboard" title-type="p">
    ...
    <Image src="placeholder-admin-dashboard-integrations.png" width="900" height="500" alt="ProductBridge admin dashboard showing the Integrations settings page" />
  </Step>
  ...
  <Step title="Click on the Intercom Integration" icon="plug" title-type="p">
    ...
    <Image src="placeholder-intercom-card-connect.png" width="900" height="500" alt="Integrations list with the Intercom integration card and Connect button highlighted" />
  </Step>
  ...
  <Step title="Authorize ProductBridge in Intercom" icon="shield" title-type="p">
    ...
    <Image src="placeholder-intercom-oauth-authorize.png" width="900" height="500" alt="Intercom OAuth authorization screen with ProductBridge app permissions" />
  ...
  <Step title="Confirm Connection" icon="check-circle" title-type="p">
    ...
    <Image src="placeholder-intercom-connected-status.png" width="900" height="500" alt="ProductBridge integration settings showing Intercom as connected with webhook and backfill status" />
  </Step>
</Steps>
...
<Image src="placeholder-intercom-sidebar-app.png" width="900" height="500" alt="ProductBridge sidebar app inside Intercom showing a list of recent feedback posts and a Create New Post button" />
...
<Steps>
  ...
  <Step title="Search or Create" icon="search" title-type="p">
    ...
    <Image src="placeholder-intercom-sidebar-search.png" width="900" height="500" alt="ProductBridge sidebar showing search input and existing feedback posts list" />
  </Step>
  ...
  <Step title="Fill the Form" icon="edit" title-type="p">
    ...
    <Image src="placeholder-intercom-sidebar-form.png" width="900" height="500" alt="ProductBridge feedback creation form inside Intercom sidebar with board selector, title, and description fields" />
  </Step>
...
<Image src="placeholder-intercom-conversation-flow.png" width="900" height="500" alt="Diagram showing flow from closed Intercom conversation to AI analysis to feedback post creation" />
...
<Image src="placeholder-intercom-feedback-post-created.png" width="900" height="500" alt="ProductBridge feedback inbox showing a feedback post created from a closed Intercom conversation with via Intercom source tag" />
