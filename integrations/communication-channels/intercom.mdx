...
<img src="https://raw.githubusercontent.com/hvemasan/documentationai-starter-kit/main/images/logos/intercom.svg" width="80" height="80" alt="" />


## Where to find it

<Card title="Open Intercom in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations/intercom" icon="message-circle" horizontal="true">
  Sidebar → **Connect Sources** → **Intercom**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/integrations/intercom](https://app.productbridge.io/dashboard/settings/integrations/intercom)

**In-app path:** Sidebar → **Connect Sources** → **Intercom**
...
<Expandable title="Troubleshooting" default-open="false">
  ...
  - **Conversations not creating feedback** — Not every conversation contains feedback. The AI pipeline only creates posts when it detects product input with sufficient confidence. Check the activity on **Connect Sources > Intercom** to see which conversations were processed and why.
  ...
  - **Re-authorize** — If the connection stops working, revoke and reconnect from **Connect Sources > Intercom**. This regenerates the OAuth token and webhook subscription.
</Expandable>
