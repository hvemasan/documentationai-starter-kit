...
description: Connect ProductBridge to Jira, Linear, ClickUp, and GitHub to link feedback posts to issues, create issues from feedback, and update post statuses automatically as work progresses.
---
...
<Columns cols={3}>
  ...
  <Card title="GitHub" icon="github" href="/integrations/project-management/github">
    Link feedback posts to GitHub issues and sync state back when they close or reopen.
  </Card>
</Columns>
