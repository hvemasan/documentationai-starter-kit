...
<Card title="Open GitHub in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations/github" icon="github" horizontal="true">
  Sidebar → **Connect Sources** → **GitHub**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/integrations/github](https://app.productbridge.io/dashboard/settings/integrations/github)

**In-app path:** Sidebar → **Connect Sources** → **GitHub**
