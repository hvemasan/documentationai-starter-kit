...
<Steps>
  <Step title="Open the Integrations page" icon="layout-dashboard" title-type="p">
    ...
    <Image src="/images/clickup/clickup-integrations-list_framed.png" width="1940" height="1100" alt="ProductBridge Connect Sources page showing the ClickUp tile under Project Management" />
  </Step>
  ...
  <Step title="Click Connect ClickUp" icon="plug" title-type="p">
    ...
    <Image src="/images/clickup/clickup-connect-button_framed.png" width="1940" height="1100" alt="ClickUp integration page in ProductBridge with the Connect ClickUp button visible" />
  </Step>
  ...
  <Step title="Authorize ProductBridge in ClickUp" icon="shield" title-type="p">
    ...
    <Image src="/images/clickup/clickup-oauth-authorize_framed.png" width="1940" height="1100" alt="ClickUp authorization screen asking to select a workspace" />
  </Step>
  ...
  <Step title="Confirm the connection" icon="check-circle" title-type="p">
    ...
    <Image src="/images/clickup/clickup-connected-state_framed.png" width="1940" height="1100" alt="ClickUp integration page showing the connected state, connection details, sync status, rules, and disconnect option" />
  </Step>
</Steps>
...
<Steps>
  <Step title="Open a feedback post" icon="message-square" title-type="p">
    ...
    <Image src="/images/clickup/clickup-post-detail-empty_framed.png" width="1940" height="1100" alt="Feedback post detail view ready to be linked to a ClickUp task" />
  </Step>
  ...
  <Step title="Choose how to link the task" icon="search" title-type="p">
    ...
    <Tabs>
      <Tab title="Search" icon="search">
        ...
        <Image src="/images/clickup/clickup-link-dialog-search_framed.png" width="1940" height="1100" alt="Link dialog Search tab with matching ClickUp tasks listed" />
      </Tab>
      ...
      <Tab title="Task ID" icon="hash">
        ...
        <Image src="/images/clickup/clickup-link-dialog-task-id_framed.png" width="1940" height="1100" alt="Link dialog Task ID tab showing a previewed ClickUp task ready to link" />
      </Tab>
      ...
      <Tab title="Create" icon="plus">
        ...
        <Image src="/images/clickup/clickup-link-dialog-create_framed.png" width="1940" height="1100" alt="Link dialog Create tab with workspace, list, status, title, and description form" />
      </Tab>
    </Tabs>
  </Step>
  ...
  <Step title="Verify the link" icon="check" title-type="p">
    ...
    <Image src="/images/clickup/clickup-post-detail-linked_framed.png" width="1940" height="1100" alt="Feedback post detail showing linked ClickUp tasks with their current statuses" />
  </Step>
</Steps>
...
<Steps>
  <Step title="Open the ClickUp settings page" icon="settings" title-type="p">
    ...
    <Image src="/images/clickup/clickup-connected-state_framed.png" width="1940" height="1100" alt="ClickUp settings page showing the Rules section before any rule has been created" />
  </Step>
  ...
  <Step title="Build the rule" icon="wand-2" title-type="p">
    ...
    <Image src="/images/clickup/clickup-rules-create_framed.png" width="1940" height="1100" alt="Create Rule form with the ClickUp status dropdown open showing real workspace statuses" />
  </Step>
  ...
  <Step title="Save the rule" icon="check-circle" title-type="p">
    ...
    <Image src="/images/clickup/clickup-rules-list_framed.png" width="1940" height="1100" alt="Rules section with a saved rule shown in plain-English form" />
  </Step>
</Steps>
