...
<Card title="Open Jira in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations/jira" icon="square-kanban" horizontal="true">
  Sidebar → **Connect Sources** → **Jira**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/integrations/jira](https://app.productbridge.io/dashboard/settings/integrations/jira)

**In-app path:** Sidebar → **Connect Sources** → **Jira**
