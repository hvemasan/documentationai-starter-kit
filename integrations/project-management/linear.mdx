...
<Card title="Open Linear in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations/linear" icon="square-kanban" horizontal="true">
  Sidebar → **Connect Sources** → **Linear**
</Card>

**Direct link:** [https://app.productbridge.io/dashboard/settings/integrations/linear](https://app.productbridge.io/dashboard/settings/integrations/linear)

**In-app path:** Sidebar → **Connect Sources** → **Linear**
