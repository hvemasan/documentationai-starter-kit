...
<Card title="Open Pabbly Connect in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations" icon="workflow" horizontal="true">
  Sidebar → **Connect Sources** → find **Pabbly Connect** in the catalog
</Card>
...
**In-app path:** Sidebar → **Connect Sources** → find **Pabbly Connect** in the catalog
...
<ExpandableGroup>
  ...
  <Expandable title="Delivery & retries" default-open="false">
    ...
    at any time from **Connect Sources → Pabbly Connect** (or [**Settings → API & Webhooks**](https://app.productbridge.io/dashboard/settings/api-webhooks)),
