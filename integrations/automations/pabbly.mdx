...
<img src="https://product-bridge.nyc3.digitaloceanspaces.com/feedback-post-files/image-1780486993708-n93z3vv.png" width="80" height="80" alt="Pabbly Connect" />
...
<Steps>
  <Step title="Add the ProductBridge app" icon="plus">
    Open the [ProductBridge app invite link](https://connect.pabbly.com/share-app/DERYagRTVzQFTwRuVB8DJAwYVVFSCwRmBh9SQFVaAnoBT1YtA0JYMlwQVHZRFgRlXhdXPVYKU25fSwEFUwUCcV1EBjlcQwZbVWYJTABfDiQMblgvBE9XbQVUBDdUHAM5DANVclIfBFkGCFJoVU4CRAFYVi0DTVh4XBxUPFEeBC5eD1dmVh1TaV9cAWBTGQJsXVYGY1xOBltVZglMAF8OJAxu) and accept the app into your Pabbly account. This is a one-time step.
  </Step>
  ...
  <Step title="Register the URL in ProductBridge" icon="link">
    In ProductBridge, go to **Settings → Integrations → Pabbly Connect**, click **Add endpoint**, paste the Pabbly webhook URL, and save.
...
<ExpandableGroup>
  ...
  <Expandable title="Delivery & retries" default-open="false">
    ...
    at any time from **Settings → Integrations → Pabbly Connect** (or **Settings → API &
    Webhooks**), which stops deliveries immediately.
  </Expandable>
</ExpandableGroup>
...
<ExpandableGroup>
  <Expandable title="Not receiving events" default-open="false">
    ...
    - Confirm the webhook URL is registered and **active** in **Settings → Integrations → Pabbly Connect**
