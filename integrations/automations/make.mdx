...
<img src="https://raw.githubusercontent.com/hvemasan/documentationai-starter-kit/main/images/logos/make.svg" width="80" height="80" alt="Make" />


## Where to find it

<Card title="Open Make in ProductBridge" href="https://app.productbridge.io/dashboard/settings/integrations" icon="workflow" horizontal="true">
  Sidebar → **Connect Sources** → find **Make** in the catalog
</Card>
...
**In-app path:** Sidebar → **Connect Sources** → find **Make** in the catalog
