...
<Card title="Open Support" href="https://app.productbridge.io/dashboard/support" icon="headset" horizontal="true">
  Sidebar → **Support**
</Card>
...
| The AI agent that answers for you — see [AI Agents](/ai-agents) | [`/dashboard/support/workflows/agent`](https://app.productbridge.io/dashboard/support/workflows/agent) |
